import {function_call_playground_validation} from "./FCvalidation.js";
...
const save_results = (results)=>{
    ...
    const filename = `fcvalidation_benchmark_${timestamp}.json`;
...
export const main_validation = async()=>{
