...
const getDefinition = async(word) => {
    ...
    try {
        ...
        response = await fetch(`https://urban-dictionary7.p.rapidapi.com/v0/define?term=${encodeURIComponent(word)}`, {
            method: 'GET',
            headers: {
...
const tool_map = new Map(tools.map(t => [t.function.name, t.function]));
...
const prompt = "What is the definition of the word 'nicotine'?";
